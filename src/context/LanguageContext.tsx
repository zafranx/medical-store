...
const translations = {
  hi: {
    ...
    audioIntroText: 'नमस्कार! राहुल मेडिकल स्टोर में आपका स्वागत है। हम अंग्रेजी और आयुर्वेदिक दवाइयों की सेवा प्रदान करते हैं। किसी भी सहायता के लिए +91 8719054515 पर कॉल करें।',
    featuredProducts: 'विशेष उत्पाद',
    qualityProductsDesc: 'आपकी भलाई के लिए गुणवत्ता वाली दवाइयाँ और स्वास्थ्य उत्पाद',
    ...
    englishMedicinesDesc: 'सभी प्रकार की एलोपैथिक दवाइयाँ, ओटीसी दवाइयाँ और प्रिस्क्रिप्शन पूर्ति',
    ayurvedicMedicinesTitle: 'आयुर्वेदिक दवाइयाँ',
    ayurvedicMedicinesDesc: 'प्राकृतिक उपचार के लिए प्रामाणिक हर्बल और शास्त्रीय आयुर्वेदिक तैयारियाँ',
    ...
    comprehensiveSolutionsDesc: 'आपकी स्वास्थ्य आवश्यकताओं के लिए संपूर्ण समाधान',
    ...
    trustedPartnerDesc: 'रीवा में आपका विश्वसनीय स्वास्थ्य साझेदार, वर्षों से गुणवत्ता दवाइयाँ और पेशेवर देखभाल प्रदान कर रहे हैं।',
  ...
  en: {
    ...
    audioIntroText: 'Welcome to Rahul Medical Store! We provide English and Ayurvedic medicines. For any assistance, call +91 8719054515.',
    featuredProducts: 'Featured Products',
    qualityProductsDesc: 'Quality medicines and healthcare products for your wellbeing',
    ...
    englishMedicinesDesc: 'All types of allopathic medicines, OTC drugs, and prescription fulfillment',
    ayurvedicMedicinesTitle: 'Ayurvedic Medicines',
    ayurvedicMedicinesDesc: 'Authentic herbal and classical Ayurvedic preparations for natural healing',
    homeDeliveryTitle: 'Home Delivery',
    homeDeliveryDesc: 'Fast and reliable medicine delivery service in Rewa area',
    twentyFourSevenService: '24/7 Service',
    twentyFourSevenServiceDesc: 'Emergency medicine availability and consultation services',
    ...
    trustedPartnerDesc: 'Your trusted healthcare partner in Rewa, providing quality medicines and professional care since years.',
